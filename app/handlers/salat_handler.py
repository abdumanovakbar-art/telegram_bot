...
async def oliviya_handler(message: Message):
    ...
    "Narxi: 25 000 so'm"
    await message.answer_photo("https://link-to-image.jpg", caption=text)
...
async def sezer_handler(message: Message):
    ...
    "Narxi: 30 000 so'm"
    await message.answer_photo("https://www.bakenroll.az/en/image/caesar-chicken-7-wolt-1x1.jpg", caption=text)